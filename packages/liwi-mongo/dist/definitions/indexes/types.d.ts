...
import type { CollationOptions, IndexDescription, IndexDescriptionInfo } from "mongodb";
import type { MongoBaseModel } from "../MongoBaseModel.ts";
export type MongoIndexDirection = -1 | "2d" | "2dsphere" | "hashed" | "text" | 1;
export type MongoIndexKey<Model extends MongoBaseModel<any>> = Partial<Record<DottedPaths<Model> | "$**" | `${DottedPaths<Model>}.$**`, MongoIndexDirection>>;
...
export interface MongoIndex<Model extends MongoBaseModel<any>> extends MongoIndexOptions<Model> {
...
export type MongoIndexComparedField = "collation" | "default_language" | "expireAfterSeconds" | "hidden" | "key" | "language_override" | "partialFilterExpression" | "sparse" | "unique" | "weights" | "wildcardProjection";

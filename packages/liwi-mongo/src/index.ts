...
export {
  default as MongoRegistry,
  type MongoRegistryOptions,
} from "./MongoRegistry.ts";
...
export {
  formatIndexPlan,
  formatIndexPlans,
} from "./indexes/formatIndexPlan.ts";
export {
  runIndexesCli,
  type RunIndexesCliParams,
} from "./indexes/runIndexesCli.ts";

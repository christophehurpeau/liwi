...
* **deps:** update dependency compression to v1.8.2 ([#736](https://github.com/christophehurpeau/liwi/issues/736))
* support update in upsert functionality with detailed result structure and tests

## [13.3.2](https://github.com/christophehurpeau/liwi/compare/v13.3.1...v13.3.2) (2026-09-13)

Note: no notable changes


## [13.3.1](https://github.com/christophehurpeau/liwi/compare/v13.3.0...v13.3.1) (2026-09-13)
...
* **deps:** update dependency mongodb to ^7.6.0 ([#733](https://github.com/christophehurpeau/liwi/issues/733))
...
* rename useResource.d.test-definitions.ts so oxfmt stops parsing it as ambient
...
* **liwi-resources-client:** expose ServiceOperation
